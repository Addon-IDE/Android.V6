类 其他_附件_资源包管理器 : 窗口
	...
	变量 线性布局3 : 线性布局
	@布局配置([[父布局=线性布局2,@左外边距DP=10,粗体=真,字体大小=16,内容="资源包管理器",字体颜色=-16777216]])
	变量 文本框3 : 文本框
	...
	方法 加载列表(路径 : 文本,刷新 : 逻辑型 = 假)
		...
		否则
			...
			事件 自定义列表框1:加载布局(索引 : 整数,项目布局 : 组件容器) : 组件容器
				变量 布局 : 其他_附件_资源包管理器_列表?
				如果 项目布局 == 空 则
					布局 = 创建 其他_附件_资源包管理器_列表
				否则
					布局 = 项目布局
				结束 如果
				//显示到列表
	...
	方法 列表单击(路径 : 文本,布局 : 其他_附件_资源包管理器_列表)
		变量 详细布局 : 其他_附件_资源包管理器_详细
		变量 详细菜单 : DX菜单
		详细菜单.自定义布局(详细布局)
		详细菜单.依附组件(布局.线性布局1)
		详细菜单.依附位置(DX对齐方式.居中)
