类 设置_行为编辑器 : 窗口
	...
	变量 线性布局3 : 线性布局
	@布局配置([[父布局=线性布局2,@左外边距DP=10,粗体=真,字体大小=16,内容="行为编辑器设置",字体颜色=-16777216]])
	变量 文本框3 : 文本框
	...
	变量 线性布局26 : 线性布局
	@布局配置([[父布局=线性布局26,@左外边距DP=10,字体颜色=-16777216,内容="重新生成资源",粗体=真,字体大小=16]])
	变量 文本框21 : 文本框
	@布局配置([[父布局=线性布局26,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="可以用来重新生成资源文件，解决文件缺失的问题"]])
	变量 文本框27 : 文本框
	...
	变量 线性布局11 : 线性布局
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-16777216,内容="主页列表显示版本",粗体=真,字体大小=16]])
	变量 文本框8 : 文本框
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="主页编辑区的列表显示版本"]])
	变量 文本框9 : 文本框
	...
	变量 线性布局22 : 线性布局
	@布局配置([[父布局=线性布局22,@左外边距DP=10,字体颜色=-16777216,内容="主页列表五彩缤纷",粗体=真,字体大小=16]])
	变量 文本框17 : 文本框
	@布局配置([[父布局=线性布局22,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="主页编辑器的列表颜色多样"]])
	变量 文本框23 : 文本框
	...
	变量 线性布局21 : 线性布局
	@布局配置([[父布局=线性布局21,@左外边距DP=10,字体颜色=-16777216,内容="文件列表打开方式",粗体=真,字体大小=16]])
	变量 文本框16 : 文本框
	@布局配置([[父布局=线性布局21,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="json文件的打开方式"]])
	变量 文本框22 : 文本框
	@布局配置([[父布局=相对布局5,宽度=-1,高度=-1,对齐方式=8388629]])
	变量 线性布局27 : 线性布局
	@布局配置([[父布局=线性布局27,字体颜色=-9145228,内容="默认"]])
	变量 文本框43 : 文本框
	...
	变量 线性布局24 : 线性布局
	@布局配置([[父布局=线性布局24,@左外边距DP=10,字体颜色=-16777216,内容="列表支持长按预览",粗体=真,字体大小=16]])
	变量 文本框19 : 文本框
	@布局配置([[父布局=线性布局24,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="长按显示一个下拉预览框，无需打开即可预览"]])
	变量 文本框25 : 文本框
	...
	变量 线性布局23 : 线性布局
	@布局配置([[父布局=线性布局23,@左外边距DP=10,字体颜色=-16777216,内容="打包导出自定义路径",粗体=真,字体大小=16]])
	变量 文本框18 : 文本框
	@布局配置([[父布局=线性布局23,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="项目打包导出自定义输出的路径"]])
	变量 文本框24 : 文本框
	...
	变量 线性布局14 : 线性布局
	@布局配置([[父布局=线性布局14,@左外边距DP=10,字体大小=15,字体颜色=-9671572,粗体=真,内容="编辑"]])
	变量 文本框10 : 文本框
	@布局配置([[父布局=线性布局13,宽度=-1,高度DP=55,水波纹效果=真,可视=真]])
	变量 相对布局1 : 相对布局
	@布局配置([[父布局=相对布局1,宽度=-1,高度=-1,纵向布局=真,对齐方式=8388627]])
	变量 线性布局5 : 线性布局
	@布局配置([[父布局=线性布局5,@左外边距DP=10,字体颜色=-16777216,内容="符号栏",粗体=真,字体大小=16]])
	变量 文本框1 : 文本框
	@布局配置([[父布局=线性布局5,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="快捷符号栏，方便添加符号"]])
	变量 文本框5 : 文本框
	...
	变量 图片框2s : 图片框
	@布局配置([[父布局=线性布局13,宽度=-1,高度DP=55,水波纹效果=真,可视=真,可用=真]])
	变量 相对布局18 : 相对布局
	@布局配置([[父布局=相对布局18,宽度=-1,高度=-1,纵向布局=真,对齐方式=8388627]])
	变量 线性布局6 : 线性布局
	@布局配置([[父布局=线性布局6,@左外边距DP=10,字体颜色=-16777216,内容="缩进",粗体=真,字体大小=16]])
	变量 文本框4 : 文本框
	@布局配置([[父布局=线性布局6,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="可用于格式化缩进"]])
	变量 文本框6 : 文本框
	@布局配置([[父布局=相对布局18,宽度=-1,高度=-1,对齐方式=8388629]])
	变量 线性布局8 : 线性布局
	@布局配置([[父布局=线性布局8,字体颜色=-9145228,内容="4"]])
	变量 文本框47 : 文本框
	...
	变量 文本框11 : 文本框
	@布局配置([[父布局=线性布局15,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="每隔5秒钟进行自动保存"]])
	变量 文本框12 : 文本框
	...
	事件 设置_行为编辑器:创建完毕()
		...
		结束 事件
		//设置
		IOS开关8.选中 = 设置_设定.获取开关("BehaviourEditorHomeDisplayVersion")
		IOS开关9.选中 = 设置_设定.获取开关("BehaviourEditorHomeListGorgeousColors")
		假如 设置_设定.获取整数("BehaviourEditorSelectListOpenMode")
			...
			是 2
				文本框43.内容 = "其他编辑"
		结束 假如
		IOS开关10.选中 = 设置_设定.获取开关("BehaviourEditorSelectListPreview")
		文本框45.内容 = 设置_设定.获取文本("BehaviourEditorCustomPackagingExportPath")
		文本框42.内容 = 设置_设定.获取文本("BehaviourEditorSelectEditSymbolsField")
		文本框47.内容 = 设置_设定.获取文本("BehaviourEditorSelectEditIndent")
		IOS开关1.选中 = 设置_设定.获取开关("BehaviourEditorSelectEditAutoSave")
		//加载夜间模式
	...
	方法 基础区按钮事件()
		...
		事件 相对布局5:被单击()
			...
			事件 XPopup:列表被单击(索引 : 整数,文本 : 文本)
				设置_设定.修改整数("BehaviourEditorSelectListOpenMode",索引)
				假如 索引
					是 0
						文本框43.内容 = "打开方式选择"
					是 1
		...
		//自定义路径
		事件 相对布局7:被单击()
			设置_编辑.文本(文本框45,"选择自定义路径","最后面请不要加：/，例如：path1/path2/path3")
		结束 事件
	结束 方法
	...
	方法 编辑区按钮事件()
		...
		//缩进
		事件 相对布局18:被单击()
			设置_编辑.整数(文本框47,"缩进","缩进用于格式化，推荐值为3，默认值为：4",2,10)
		结束 事件
	结束 方法
	...
	//保存
	方法 保存()
		设置_设定.修改开关("BehaviourEditorHomeDisplayVersion",IOS开关8.选中)
		设置_设定.修改开关("BehaviourEditorHomeListGorgeousColors",IOS开关9.选中)
		设置_设定.修改开关("BehaviourEditorSelectListPreview",IOS开关10.选中)
		设置_设定.修改文本("BehaviourEditorCustomPackagingExportPath",文本框45.内容)
		设置_设定.修改文本("BehaviourEditorSelectEditSymbolsField",文本框42.内容)
		设置_设定.修改整数("BehaviourEditorSelectEditIndent",文本框47.内容.到整数())
		设置_设定.修改开关("BehaviourEditorSelectEditAutoSave",IOS开关1.选中)
	结束 方法
