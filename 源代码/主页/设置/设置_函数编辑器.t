类 设置_函数编辑器 : 窗口
	...
	变量 线性布局3 : 线性布局
	@布局配置([[父布局=线性布局2,@左外边距DP=10,粗体=真,字体大小=16,内容="函数编辑器",字体颜色=-16777216]])
	变量 文本框3 : 文本框
	@布局配置([[父布局=线性布局1,宽度=-1,高度=-1,完全显示=假,显示滚动条=假]])
	变量 滚动布局1 : 滚动布局
	@布局配置([[父布局=滚动布局1,宽度=-1,高度=-1,纵向布局=真,右内边距DP=10,左内边距DP=10]])
	变量 线性布局4 : 线性布局
	@布局配置([[父布局=线性布局4,@上外边距DP=10,字体大小=13,字体颜色=-14445329,内容="函数编辑器的大部分设定都在代码编辑器设置中，代码编辑器的设置同时也应用到函数编辑器"]])
	变量 文本框51 : 文本框
	...
	变量 线性布局11 : 线性布局
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-16777216,内容="新§颜色符号栏",粗体=真,字体大小=16]])
	变量 文本框8 : 文本框
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="启用新§颜色符号栏(1.20+)"]])
	变量 文本框9 : 文本框
	...
	变量 线性布局21 : 线性布局
	@布局配置([[父布局=线性布局21,@左外边距DP=10,字体颜色=-16777216,内容="自动保存",粗体=真,字体大小=16]])
	变量 文本框16 : 文本框
	@布局配置([[父布局=线性布局21,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="文件自动保存"]])
	变量 文本框22 : 文本框
	@布局配置([[父布局=相对布局5,宽度=-1,高度=-1,对齐方式=8388629]])
	变量 线性布局27 : 线性布局
	@布局配置([[父布局=线性布局27,宽度DP=55,高度DP=35,@右外边距DP=10]])
	变量 IOS开关2 : IOS开关
	@布局配置([[父布局=线性布局9,宽度=-1,高度DP=55,水波纹效果=真]])
	变量 相对布局6 : 相对布局
	@布局配置([[父布局=相对布局6,宽度=-1,高度=-1,纵向布局=真,对齐方式=8388627]])
	变量 线性布局22 : 线性布局
	@布局配置([[父布局=线性布局22,@左外边距DP=10,字体颜色=-16777216,内容="自动换行",粗体=真,字体大小=16]])
	变量 文本框17 : 文本框
	@布局配置([[父布局=线性布局22,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="超出一定宽度自动切换下一行"]])
	变量 文本框23 : 文本框
	...
	变量 线性布局23 : 线性布局
	@布局配置([[父布局=线性布局23,@左外边距DP=10,字体颜色=-16777216,内容="自动补全",粗体=真,字体大小=16]])
	变量 文本框18 : 文本框
	@布局配置([[父布局=线性布局23,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="官方人员自己设计的代码补全"]])
	变量 文本框24 : 文本框
	@布局配置([[父布局=相对布局7,宽度=-1,高度=-1,对齐方式=8388629]])
	变量 线性布局29 : 线性布局
	@布局配置([[父布局=线性布局29,字体颜色=-9145228,内容=""]])
	变量 文本框45 : 文本框
	@布局配置([[父布局=线性布局29,宽度DP=55,高度DP=35,@右外边距DP=10]])
	变量 IOS开关13 : IOS开关
	@布局配置([[父布局=线性布局9,宽度=-1,高度DP=55,水波纹效果=真]])
	变量 相对布局8 : 相对布局
	@布局配置([[父布局=相对布局8,宽度=-1,高度=-1,纵向布局=真,对齐方式=8388627]])
	变量 线性布局24 : 线性布局
	@布局配置([[父布局=线性布局24,@左外边距DP=10,字体颜色=-16777216,内容="旧自动补全",粗体=真,字体大小=16]])
	变量 文本框19 : 文本框
	@布局配置([[父布局=线性布局24,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="代码编辑框默认补全"]])
	变量 文本框25 : 文本框
	...
	变量 线性布局25 : 线性布局
	@布局配置([[父布局=线性布局25,@左外边距DP=10,字体颜色=-16777216,内容="浏览器高度",粗体=真,字体大小=16]])
	变量 文本框20 : 文本框
	@布局配置([[父布局=线性布局25,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="浏览器高度"]])
	变量 文本框26 : 文本框
	@布局配置([[父布局=相对布局9,宽度=-1,高度=-1,对齐方式=8388629]])
	变量 线性布局31 : 线性布局
	@布局配置([[父布局=线性布局31,字体颜色=-9145228,内容="标题"]])
	变量 文本框43 : 文本框
	...
	变量 线性布局26 : 线性布局
	@布局配置([[父布局=线性布局26,@左外边距DP=10,字体颜色=-16777216,内容="符号栏",粗体=真,字体大小=16]])
	变量 文本框21 : 文本框
	@布局配置([[父布局=线性布局26,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="输入法上方符号栏"]])
	变量 文本框27 : 文本框
	...
	事件 设置_函数编辑器:创建完毕()
		...
		结束 事件
		//设置
		IOS开关8.选中 = 设置_设定.获取开关("FunctionEditorNewColorSymbol")
		IOS开关2.选中 = 设置_设定.获取开关("FunctionEditorAutoSave")
		IOS开关9.选中 = 设置_设定.获取开关("FunctionEditorWordWrap")
		IOS开关13.选中 = 设置_设定.获取开关("FunctionEditorAutocomplete")
		IOS开关10.选中 = 设置_设定.获取开关("FunctionEditorOldAutocomplete")
		文本框43.内容 = 设置_设定.获取整数("FunctionEditorBrowserHeight").到文本()
		文本框50.内容 = 设置_设定.获取文本("FunctionEditorSymbolBar")
		//加载夜间模式
	...
	方法 基础区按钮事件()
		//浏览器高度
		事件 相对布局9:被单击()
			设置_编辑.整数(文本框43,"浏览器高度","浏览器高度,默认：800",100,1500)
		结束 事件
		//符号栏
		事件 相对布局10:被单击()
			设置_编辑.文本(文本框50,"符号栏","")
	...
	//保存
	方法 保存()
		设置_设定.修改开关("FunctionEditorNewColorSymbol",IOS开关8.选中)
		设置_设定.修改开关("FunctionEditorAutoSave",IOS开关2.选中)
		设置_设定.修改开关("FunctionEditorWordWrap",IOS开关9.选中)
		设置_设定.修改开关("FunctionEditorAutocomplete",IOS开关13.选中)
		设置_设定.修改开关("FunctionEditorOldAutocomplete",IOS开关10.选中)
		设置_设定.修改整数("FunctionEditorBrowserHeight",文本框43.内容.到整数())
		设置_设定.修改文本("FunctionEditorSymbolBar",文本框50.内容)
	结束 方法
