类 设置_账户设定 : 窗口
	...
	变量 线性布局3 : 线性布局
	@布局配置([[父布局=线性布局2,@左外边距DP=10,粗体=真,字体大小=16,内容="账户设定",字体颜色=-16777216]])
	变量 文本框3 : 文本框
	...
	变量 线性布局10 : 线性布局
	@布局配置([[父布局=线性布局10,@左外边距DP=10,字体大小=15,字体颜色=-9671572,粗体=真,内容="登录注册"]])
	变量 文本框7 : 文本框
	@布局配置([[父布局=线性布局9,宽度=-1,高度DP=55,水波纹效果=真]])
	变量 相对布局5 : 相对布局
	@布局配置([[父布局=相对布局5,宽度=-1,高度=-1,纵向布局=真,对齐方式=8388627]])
	变量 线性布局21 : 线性布局
	@布局配置([[父布局=线性布局21,@左外边距DP=10,字体颜色=-16777216,内容="登录",粗体=真,字体大小=16]])
	变量 文本框16 : 文本框
	...
	变量 线性布局23 : 线性布局
	@布局配置([[父布局=线性布局23,@左外边距DP=10,字体颜色=-16777216,内容="注册",粗体=真,字体大小=16]])
	变量 文本框18 : 文本框
	...
	变量 线性布局11 : 线性布局
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-16777216,内容="密钥",粗体=真,字体大小=16]])
	变量 文本框8 : 文本框
	@布局配置([[父布局=线性布局11,@左外边距DP=10,字体颜色=-9145228,@上外边距DP=3,内容="可通过密钥文件直接进行登录"]])
	变量 文本框9 : 文本框
