...
public class CodeEditor extends View implements ContentListener, TextAnalyzer.Callback, FormatThread.FormatResultReceiver, LineRemoveListener {
    ...
    */
    private OnCodeChangedListener mListeners;
    ...
    public float getOffset2(int line, int column) {
        return mLayout.getCharLayoutOffset(line, column)[0] - getOffsetX();
    }
    ...
    private void initialize() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            try {
                ...
                Method method = View.class.getDeclaredMethod("getVerticalScrollFactor");
    ...
    protected void drawRows(Canvas canvas, float offset, LongArrayList postDrawLineNumbers, List<CursorPaintAction> postDrawCursor, LongArrayList postDrawCurrentLines, MutableInt requiredFirstLn) {
        ...
        for (int row = getFirstVisibleRow(); row <= getLastVisibleRow() && rowIterator.hasNext(); row++) {
            ...
            while (temporaryOffset < getWidth() && lastVisibleChar < columnCount) {
                ...
                if (isEmoji(ch)) {
                    int end = Math.min(lastVisibleChar + 4, columnCount);
    ...
    protected void drawSelectionOnAnimation(Canvas canvas) {
        ...
        if (mInsertHandle != null && mEventHandler.shouldDrawInsertHandle()) {
            ...
            mInsertHandle.round(resultRect);
    ...
    protected float[] findFirstVisibleChar(float initialPosition, int left, int right, char[] chars) {
        ...
        while (left < right && initialPosition + width < -target) {
            ...
            if (chars[left] == '\t') {
                ...
                if (left + 4 <= right) {
                float[] widths = mFontCache.widths;
    ...
    protected void onSelectionChanged() {
        ...
        final EditorEventListener listener = mListener;
        if (listener != null) {
    ...
    public void afterInsert(Content content, int startLine, int startColumn, int endLine, int endColumn, CharSequence insertedContent) {
        ...
        mListeners.onCodeChanged(insertedContent.toString());
    }
    ...
    public void afterDelete(Content content, int startLine, int startColumn, int endLine, int endColumn, CharSequence deletedContent) {
        ...
        mListeners.onCodeChanged2(deletedContent.toString());
    }
